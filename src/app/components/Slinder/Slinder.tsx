    ...
    const Slides = [
        {
            ...
            description:"Get ready for the summer with our exclusive collection. Limited time offer!",
        ...
        },
        {
            ...
            description:"Explore our cozy winter collection. Perfect for the chilly days ahead.",
        ...
        },
        {
            ...
            description:"Fresh styles for the spring season. Embrace the bloom!",
      ...
      <div className='w-max h-full flex transition-all ease-in-out duration-1000'>
        {Slides.map((slide) => (
            <div key={slide.id} className={`${slide.bg} w-screen h-full flex flex-col gap-16 xl:flex-row mt-5 p-4 `}>
                {/* TEXT CONTAINER */}
                <div className='h-1/2 xl:w-1/2 xl:h-full fle flex-col items-center justify-center gap-8 xl:gap-12 text-center'>
                    <h2 className='text-xl xl:text-3xl 2xl:text-5xl font-semibold mb-4'>{slide.description}</h2>
